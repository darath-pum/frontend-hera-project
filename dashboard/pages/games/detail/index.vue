<template>
    <div class="container game-detail p-5 pb-32">
        ...
        <div class="detail-info flex flex-col sm:flex-row gap-10 sm:justify-center">
            ...
            <div class="flex flex-col gap-10 border-gray-300">
                <div class="space-y-5">
                    <div class="flex flex-row items-center gap-2">
                        <h2 class="text-2xl font-semibold">Mobile Legend</h2>
                    ...
                    <p class="max-w-[500px]">Considering factors such as objectives, budget, target audience.Considering
                        factors
                        budget, target audience.Considering factors,target audience.Considering factors
                        such as objectives, budget, target audience.</p>
                </div>
                <div class="qr-code flex flex-col gap-5 justify-center items-center sm:items-start pb-24">
                    ...
                    <div>
                        <button class="secondary-btn">Download QR Code</button>
                    </div>
                </div>
            </div>
        </div>
